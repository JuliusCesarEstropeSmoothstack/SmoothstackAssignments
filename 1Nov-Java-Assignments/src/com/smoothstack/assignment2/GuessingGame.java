	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 5; i++) {
			try {
				...
				if (((guess > answer) ? guess - answer : answer - guess) <= 10) { // Check that the guess is within 10
																					// of the answer
			...
			} catch (InputMismatchException ime) { // If user enters invalid input, ask them to enter the correct input
													// and don't count it against them
